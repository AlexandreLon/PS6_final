...
module.exports = class BaseModel {
  ...
  // This function can be used if you want modify attribut on elements
  getAddress() {
    return this.items;
  }
  ...
  // This function can be used if you want modify attribut on element
  getAddressById(id) {
    if (typeof id === 'string') id = parseInt(id, 10);
    const item = this.items.find(i => i.id === id);
    if (!item) throw new NotFoundError(`Cannot get ${this.name} id=${id} : not found`);
  ...
  create(obj = {}) {
    const item = obj.id == undefined
      ? Object.assign({}, obj, { id: Date.now() })
      : Object.assign({}, obj);
